      ...
      <section className="container py-16">
        <div className="max-w-4xl mx-auto">
          <div className="prose prose-neutral max-w-none prose-headings:font-heading prose-headings:text-secondary prose-h2:text-2xl prose-h3:text-xl prose-p:text-muted-foreground prose-a:text-gold hover:prose-a:underline prose-strong:text-foreground">
            ...
            <p>
              We make every effort to display the colors and images of our
              products as accurately as possible. However, we cannot guarantee
            ...
            <p>
              ...
              offer to purchase the products in your order. We reserve the right
              to refuse or cancel any order for any reason, including product
            ...
            <p>
              We deliver across Pakistan. Delivery times vary based on your
              location. Please refer to our{" "}
              <a href="/shipping">Shipping Policy</a> for detailed information
            ...
            <p>
              ...
              are not satisfied, you may return products within 7 days of
              delivery. Please refer to our{" "}
              <a href="/shipping">Shipping and Returns</a> page for detailed
              information about our return policy.
            </p>

            <h2>Intellectual Property</h2>
            <p>
              All content on this website, including text, graphics, logos,
              images, and software, is the property of Light House and is
              protected by copyright and trademark laws.
            </p>

            <h2>Limitation of Liability</h2>
            <p>
              Light House shall not be liable for any indirect, incidental,

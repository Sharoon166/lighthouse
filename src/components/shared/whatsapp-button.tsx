...
const WHATSAPP_MESSAGE =
  "Hi Lighthouse! I'd like to know more about your lighting options.";
...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-0 overflow-hidden rounded-full bg-[#25D366] text-white transition-all duration-300 hover:gap-2 hover:bg-[#1ebe5b] sm:bottom-8 sm:right-8"
      style={{
        opacity: visible ? 1 : 0,
